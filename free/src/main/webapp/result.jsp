...
<body>
	<br><br><br>
	<header class="text-dark" style="text-align:center;">Welcome</header>
	<br><br><br>
	<section>
	<div>
	...
	<br>
	<div align=center><a href="http://localhost:8080/jungeun_free/MemberServlet?cmd=list">전체회원목록보기</a></div>
	<section class="py-4">
